...
sfpi_inline sfpi::vInt compute_unsigned_remainder_int32(const sfpi::vInt& a_signed, const sfpi::vInt& b_signed) {
    ...
    sfpi::vInt qb;
    qb = sfpi::vInt(__builtin_rvtt_sfpmul24(q.get(), b.get(), 0));
    qb <<= 10;
    ...
    tmp_lo = sfpi::vInt(__builtin_rvtt_sfpmul24(correction.get(), b.get(), 0));
    tmp_hi = sfpi::vInt(__builtin_rvtt_sfpmul24(correction.get(), b.get(), 1));
    b_hi = b >> 23;
    b_hi = sfpi::vInt(__builtin_rvtt_sfpmul24(correction.get(), b_hi.get(), 0));
